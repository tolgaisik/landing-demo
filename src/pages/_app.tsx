...
export default function App({ Component, pageProps }: AppProps) {
	...
	return (
		<>
			<header className='flex flex-row w-screen  fixed top-0 z-10 justify-between bg-black font-bold uppercase px-4 md:px-20'>
				<nav>
			...
			<main
				ref={ref}
				className='p-4 md:p-20 relative bg-gradient-to-r grid grid-cols-3'
			>
				<Component {...pageProps} />
